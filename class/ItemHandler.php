...
class MenuItemHandler extends icms_ipf_Handler {
	...
	public function getItems($act = FALSE, $item_pid = NULL, $menu_id = FALSE, $start=0,$limit=0,$order=$GLOBALS['MENU_ITEM_ORDER'],$sort=$GLOBALS['MENU_ITEM_SORT'],$perm="item_view") {
