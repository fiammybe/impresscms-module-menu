...
define("_CO_MENU_MENU_MENU_KIND_DSC", "");
...
define("_CO_MENU_ITEM_ITEM_URL_DSC", "You can enter a full url or use <br /> {\$_ICMS_URL} to get the icms base url <br /> {\$_MOD_URL} to get the modules url to /modules/ or <br /> {\$_UID} to get the uid");
